...
// Alterado para mostrar todos apenas na loja e 6 nas demais páginas
function cks_loop_shop_per_page($products) {
  if ( is_shop() ) {
    return -1; 
  }
  return 6; 
}
add_filter('loop_shop_per_page', 'cks_loop_shop_per_page', 99);
...
// Comentado para evitar que o layout do WooCommerce quebre
